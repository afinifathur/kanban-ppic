...
<head>
    ...
    @php
        ...
        $isExpandedPrint = $lineCount > 10;
        $draftMode = $printOrder->status === 'DRAFT';
        $compactRowCount = 10;
        $expandedRowCount = 30;
    @endphp
    <style>
...
<body class="p-4 bg-slate-50 print:bg-white print:p-0" onload="window.print()" data-print-layout="{{ $isExpandedPrint ? 'expanded' : 'compact' }}">
            ...
            <div class="max-w-4xl mx-auto bg-white p-6 shadow-sm border border-slate-200 print:border-none print:shadow-none print:w-full print:p-0">
                ...
                <div class="print-form-page">
                    ...
                    <table class="w-full border-collapse border border-black text-xs mb-2 table-fixed">
                        ...
                        <tbody>
                            @foreach($lines->take($compactRowCount) as $index => $line)
                                <tr class="h-6">
                            ...
                            @endforeach
                            @for($i = $lineCount; $i < $compactRowCount; $i++)
                                <tr class="h-6">
                    ...
                    <div class="print-form-page">
                        ...
                        <table class="w-full border-collapse border border-black text-xs mb-2 table-fixed">
                            ...
                            <tbody>
                                ...
                                @endforeach
                                @for($i = $lineCount; $i < $expandedRowCount; $i++)
                                    <tr class="h-6">
                                        <td class="border border-black p-1 text-center font-bold text-slate-300">{{ $i + 1 }}</td>
                                        <td class="border border-black p-1"></td>
                                        <td class="border border-black p-1"></td>
                        ...
                        <div class="border border-black p-2 mb-2 text-xs min-h-[48px]">
                            <div class="text-[9px] text-slate-500 uppercase font-bold mb-1">KETERANGAN / CATATAN :</div>
